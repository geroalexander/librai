...
import { getBookById } from '../booksApiService/getBookById';
...
const getCompatScore = async (user, book) => {
  ...
  const compatabilityScore = hasGoodRating + isFavoriteGenre + similarityWithPast + similarityWithRecomms
  return compatabilityScore;
}

export default getCompatScore;
